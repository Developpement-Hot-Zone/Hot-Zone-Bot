...
class Infos(commands.Cog):
    ...
    async def infos(self, interaction: discord.Interaction):
        ...
        welcome_data_path = "../../Data/Welcome/welcome_data.json"
        ...
        ai_data_path = "../../Data/AI/statut.json"
        ...
        minimum_age_path = "../../Data/Minimum_age/minimum_age.json"
        ...
        # Salons bloqués
        chan_lock_path = "../../Data/Chan_lock/chan_lock_status.json"
        ...
        birthday_config_path = f"../../Data/Birthday/server_{guild.id}.json"
        ...
        aov_data_path = "../../Data/AOV/aov_players.json"
        ...
        confession_counter_path = "../../Data/Confessions/confession_counter.json"
        ...
        convocations_path = "../../Data/Convocations/convocations.json"
        ...
        dm_requests_path = "../../Data/DM_request/dm_requests.json"
