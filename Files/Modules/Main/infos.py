...
class Infos(commands.Cog):
    def __init__(self, bot):
        self.bot = bot
        logging.info("Infos module initialized.")
    ...
    async def infos(self, interaction: discord.Interaction):
        ...
        welcome_data_path = os.path.join(os.getcwd(), "Files/Data/Welcome/welcome_data.json")
        ...
        ai_data_path = os.path.join(os.getcwd(), "Files/Data/AI/statut.json")
        ...
        minimum_age_path = os.path.join(os.getcwd(), "Files/Data/Minimum_age/minimum_age.json")
        ...
        # Salons bloqués
        chan_lock_path = os.path.join(os.getcwd(), "Files/Data/Chan_lock/chan_lock_status.json")
        ...
        # Serveur en lockdown
        lockdown_path = os.path.join(os.getcwd(), "Files/Data/Lockdown/lockdown_perms_backup.json")
        is_lockdown = "Oui" if os.path.exists(lockdown_path) else "Non"

        # Configuration du système d'anniversaires
        birthday_config_path = os.path.join(os.getcwd(), f"Files/Data/Birthday/server_{guild.id}.json")
        ...
        aov_data_path = os.path.join(os.getcwd(), "Files/Data/AOV/aov_players.json")
        ...
        confession_counter_path = os.path.join(os.getcwd(), "Files/Data/Confessions/confession_counter.json")
        ...
        convocations_path = os.path.join(os.getcwd(), "Files/Data/Convocations/convocations.json")
        ...
        dm_requests_path = os.path.join(os.getcwd(), "Files/Data/DM_request/dm_requests.json")
